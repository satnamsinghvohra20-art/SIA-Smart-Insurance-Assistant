# S.I.A. (Smart Insurance Assistant): 3-Minute Live Demo Presentation Script
...
**Solution:** S.I.A. (Smart Insurance Assistant) — an autonomous, multi-agent AI system built on Google Cloud (Gemini 3.5, Cloud Run, Firestore, Pub/Sub) that discovers, verifies, prepares, and tracks eligible medical claims with strict human-in-the-loop safety gates.
...
- **Speaker:** *"Welcome to S.I.A. (Smart Insurance Assistant). Let's look at a common, high-impact scenario: an Indian corporate employee undergoing emergency surgery (appendectomy) at an in-network hospital."*
...
- **Speaker:** *"Unlike probabilistic chatbots that hallucinate financial figures, S.I.A. uses a deterministic rules engine aligned with IRDAI guidelines."*
- **Visual Highlight:**
...
- **Speaker:** *"S.I.A. enforces a strict safety invariant: the system never submits a legally binding claim or signs paperwork without explicit human approval."*
- **Visual Highlight:**
